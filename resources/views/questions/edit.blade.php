<form action="{{ route('questions.update', $question->id) }}" method="POST" autocomplete="off">
    @csrf
    @method('PUT')
    <div class="modal fade" id="editQuestion" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="question" rows="4" required>{{ $question->question }}</textarea>
                    </div>
                </div>
